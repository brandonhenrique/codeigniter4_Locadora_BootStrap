...
<div class="container mt-5">   
            <center><h4 class="text-dark">Alterar Cadastro das Marcas</h4></center>
            ...
            <div class="row align-items-start mt-5">
                ...
                <div class="col border rounded">                    
                    ...
                    <?php
                        ...
                        echo form_input('TB_MARCA_ID', $editar['TB_MARCA_ID'], $id);
                    
                        echo form_label('Digite a Marca ', 'TB_MARCA_NOME'); 
                        echo form_input('TB_MARCA_NOME', $editar['TB_MARCA_NOME'], $input);
